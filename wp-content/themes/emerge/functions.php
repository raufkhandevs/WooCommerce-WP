...
/**
 * Carbon Fields integration for adding a PDF File meta field to WooCommerce products.
 *
...
// Register custom PDF File field for WooCommerce products.
add_action('carbon_fields_register_fields', 'custom_product_pdf_field');
function custom_product_pdf_field()
{
    Carbon_Fields\Container::make('post_meta', 'PDF File')
        ->where('post_type', '=', 'product')
        ->add_fields([
            Carbon_Fields\Field::make('file', 'pdf_file', 'PDF File'),
        ]);
}
